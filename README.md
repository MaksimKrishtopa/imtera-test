...
Перехват внутреннего API Яндекса вместо DOM-скрапинга. Это быстрее и не ломается при изменении вёрстки;

Больше отзывов — сейчас 250-300 из-за ограничения RAM на бесплатной версии Railway (512 МБ). На сервере с 1+ ГБ можно получить все 570+;

Обработка нескольких организаций — сейчас одна на пользователя, архитектурно легко расширить.
